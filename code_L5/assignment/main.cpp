        ...
        else if (tradeType == "TreeProduct")
        {
            ...
            if (treePtr)
            {
                ...
                else if (euroOption)
                {
                    ...
                    cout << "EuroOption " << euroOption->getOptionType() << ": " << euroOption->getAssetName() << ", Present Value: " << pv << endl;
                    outFile << "EuroOption " << euroOption->getOptionType() << ": " << euroOption->getAssetName() << ", Present Value: " << pv << "#" << endl;
                ...
                else if (amerOption)
                {
                    ...
                    double pv = treePricer->Price(mkt, trade);
                    cout << "AmericanOption " << amerOption->getOptionType() << ": " << amerOption->getAssetName() << ", Present Value: " << pv << endl;
                    outFile << "AmericanOption " << amerOption->getOptionType() << ": " << amerOption->getAssetName() << ", Present Value: " << pv << "#" << endl;
                }
